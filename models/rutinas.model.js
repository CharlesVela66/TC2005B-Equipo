...
module.exports = class Rutina {
    ...
    constructor(nueva_rutina) {
        this.id_rutina =nueva_rutina.id_rutina;
        this.nombre = nueva_rutina.nombre || "";
        this.tiporutina = nueva_rutina.tiporutina || "";
        this.descripcion = nueva_rutina.descripcion || "";
        this.URL_Image= nueva_rutina.URL_Image || null;
    }

    //Este método servirá para guardar de manera persistente el nuevo objeto. 
    save() {
        return db.execute(`
            INSERT INTO  rutina(id_rutina,nombre,tiporutina,descripcion,URL_Image) 
            values (?, ?, ?, ?, ?)
        `, [this.id_rutina, this.nombre, this.tiporutina, this.descripcion, this.URL_Image]);
    }
